...
// Database user
define('DC_DBUSER','myivan4049');

// Database password
define('DC_DBPASSWORD','AQw5Gu9I');

// Database name
define('DC_DBNAME','dotclear174t');

// Tables' prefix
define('DC_DBPREFIX','dc_e');

// Persistent database connection
define('DC_DBPERSIST', false);

// Crypt key (password storage)
define('DC_MASTER_KEY','d3ed9f24776b581f05e1de6272dabd7b');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://www.ivan.es.mialias.net/dotclear/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','gomez.mateos.ivan@iescamas.es');
